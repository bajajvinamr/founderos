...
export function createToolDefinitions(client: FounderOSApiClient): ToolDefinition[] {
  return [
    makeTool(
      "founderosMe",
      "Get the current authenticated FounderOS actor details",
      z.object({}),
    ...
    makeTool(
      "founderosApiRequest",
      "Make a JSON request to an existing FounderOS /api endpoint for unsupported operations",
      apiRequestSchema,
