...
import type { PluginCategory, PluginStatus, FounderOSPluginManifestV1 } from "@founderos/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<FounderOSPluginManifestV1>().notNull(),
