...
- FounderOS auto-injects local skills into "~/.cursor/skills" when missing, so Cursor can discover "$founderos" and related skills on local runs.
- FounderOS auto-adds --yolo unless one of --trust/--yolo/-f is already present in extraArgs.
`;
