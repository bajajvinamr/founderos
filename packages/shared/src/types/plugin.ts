...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within FounderOSPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the FounderOS host.
 *
...
export interface FounderOSPluginManifestV1 {
   ...
   */
  minimumFounderOSVersion?: PluginMinimumHostVersion;
