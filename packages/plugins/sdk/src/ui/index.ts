/**
 * `@founderos/plugin-sdk/ui` — FounderOS plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@founderos/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@founderos/plugin-sdk/ui";
 *
