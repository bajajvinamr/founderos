/**
 * `definePlugin` — the top-level helper for authoring a FounderOS plugin.
 *
...
// ---------------------------------------------------------------------------
// FounderOSPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface FounderOSPlugin {
 ...
 * @returns A sealed `FounderOSPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@founderos/plugin-sdk";
