/**
 * Bundling presets for FounderOS plugins.
 *
 ...
 * to match the FounderOS plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@founderos/plugin-sdk/ui",
    "@founderos/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
