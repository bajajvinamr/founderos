import type { PluginLauncherRegistration } from "@founderos/plugin-sdk";

export const PLUGIN_ID = "founderos-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".founderos-kitchen-sink-demo.txt",
} as const;
