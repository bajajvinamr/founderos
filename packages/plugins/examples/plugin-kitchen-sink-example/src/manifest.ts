...
const manifest: FounderOSPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current FounderOS plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "FounderOS",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the FounderOS domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
