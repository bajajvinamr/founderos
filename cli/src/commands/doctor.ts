...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" founderos doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `founderos configure --section database` or `founderos onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadFounderOSEnvFile(input.configPath);
