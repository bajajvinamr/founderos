...
Eval framework for testing FounderOS agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the FounderOS heartbeat skill:
