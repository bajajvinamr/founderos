...
import * as serverUtils from "@founderos/adapter-utils/server-utils";
export type { RunProcessResult } from "@founderos/adapter-utils/server-utils";
...
export const buildFounderOSEnv = serverUtils.buildFounderOSEnv;
...
export function buildInvocationEnvForLogs(
  ...
  // TODO: Remove this fallback once @founderos/adapter-utils exports buildInvocationEnvForLogs everywhere we consume it.
