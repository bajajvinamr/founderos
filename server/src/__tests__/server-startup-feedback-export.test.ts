...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://founderos:founderos@127.0.0.1:5432/founderos",
    embeddedPostgresDataDir: "/tmp/founderos-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/founderos-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/founderos-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/founderos-storage",
    storageS3Bucket: "founderos-test",
