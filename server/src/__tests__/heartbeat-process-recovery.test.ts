...
vi.mock("@founderos/shared/telemetry", async () => {
  const actual = await vi.importActual<typeof import("@founderos/shared/telemetry")>(
    "@founderos/shared/telemetry",
  );
  return {
    ...actual,
...
describeEmbeddedPostgres("heartbeat orphaned process recovery", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("founderos-heartbeat-recovery-");
