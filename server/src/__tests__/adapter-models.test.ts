...
import { models as codexFallbackModels } from "@founderos/adapter-codex-local";
import { models as cursorFallbackModels } from "@founderos/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@founderos/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@founderos/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.FOUNDEROS_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.FOUNDEROS_OPENCODE_COMMAND = "__founderos_missing_opencode_command__";
