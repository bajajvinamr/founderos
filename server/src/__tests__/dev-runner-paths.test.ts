...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local FounderOS state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".founderos/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/founderos",
      ),
    ).toBe(false);
