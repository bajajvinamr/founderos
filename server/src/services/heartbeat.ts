...
const DEFERRED_WAKE_CONTEXT_KEY = "_founderosWakeContext";
const WAKE_COMMENT_IDS_KEY = "wakeCommentIds";
const FOUNDEROS_WAKE_PAYLOAD_KEY = "founderosWake";
const DETACHED_PROCESS_ERROR_CODE = "process_detached";
const startLocksByAgent = new Map<string, Promise<void>>();
const REPO_ONLY_CWD_SENTINEL = "/__founderos_repo_only__";
...
async function buildFounderOSWakePayload(input: {
  db: Db;
  companyId: string;
  contextSnapshot: Record<string, unknown>;
  issueSummary?:
