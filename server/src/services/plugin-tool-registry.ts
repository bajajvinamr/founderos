...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@founderos/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: FounderOSPluginManifestV1, pluginDbId?: string): void;
