 ...
 * ~/.founderos/adapter-plugins.json. This is the source of truth for which
...
const FOUNDEROS_DIR = path.join(os.homedir(), ".founderos");
const ADAPTER_PLUGINS_DIR = path.join(FOUNDEROS_DIR, "adapter-plugins");
const ADAPTER_PLUGINS_STORE_PATH = path.join(FOUNDEROS_DIR, "adapter-plugins.json");
const ADAPTER_SETTINGS_PATH = path.join(FOUNDEROS_DIR, "adapter-settings.json");
