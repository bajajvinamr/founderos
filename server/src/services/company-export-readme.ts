 ...
 */
import type { CompanyPortabilityManifest } from "@founderos/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [FounderOS](https://founderos.ai)");
  lines.push("");
