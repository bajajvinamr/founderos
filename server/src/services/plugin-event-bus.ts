/**
 * PluginEventBus — typed in-process event bus for the FounderOS plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@founderos/shared";
import type { PluginEvent, EventFilter } from "@founderos/plugin-sdk";
