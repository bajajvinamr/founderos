...
import { buildSkillMentionHref } from "@founderos/shared";
import {
...
describe("MarkdownEditor", () => {
  ...
  it("keeps mention queries active across spaces", () => {
    expect(findMentionMatch("Ping @FounderOS App", "Ping @FounderOS App".length)).toEqual({
      trigger: "mention",
      marker: "@",
      query: "FounderOS App",
      atPos: 5,
      endPos: "Ping @FounderOS App".length,
    });
  });
