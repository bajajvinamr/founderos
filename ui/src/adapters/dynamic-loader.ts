 ...
 *
 * When the FounderOS UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and FounderOS's UI loads it on demand.
 */

import type { TranscriptEntry } from "@founderos/adapter-utils";
