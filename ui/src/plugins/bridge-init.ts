 ...
 *
 * This is placed on `globalThis.__founderosPluginBridge__` and consumed by
...
declare global {
  ...
  var __founderosPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__founderosPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__founderosPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
