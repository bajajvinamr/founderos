...
import type { ExecutionWorkspace, Issue, Project, ProjectWorkspace } from "@founderos/shared";
...
function ExecutionWorkspaceIssuesList({
  ...
  return (
    <IssuesList
      ...
      viewStateKey={`founderos:execution-workspace-view:${workspaceId}`}
...
export function ExecutionWorkspaceDetail() {
  ...
  if (workspaceId && activeTab === null) {
    ...
    try {
      const storedTab = localStorage.getItem(`founderos:execution-workspace-tab:${workspaceId}`);
  ...
  const handleTabChange = (tab: ExecutionWorkspaceTab) => {
    try {
      localStorage.setItem(`founderos:execution-workspace-tab:${workspace.id}`, tab);
    } catch {}
      ...
      <div className="mx-auto max-w-5xl space-y-4 overflow-hidden sm:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Configure the concrete runtime workspace that FounderOS reuses for this issue flow.
          ...
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(18rem,0.95fr)]">
            <div className="min-w-0 space-y-4 sm:space-y-6">
              <div className="rounded-2xl border border-border bg-card p-4 sm:p-5">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  <Field label="Provision command" hint="Runs when FounderOS prepares this execution workspace">
                    <textarea
