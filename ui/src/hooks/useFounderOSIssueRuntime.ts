...
export interface FounderOSIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface FounderOSIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: FounderOSIssueRuntimeReassignment;
}

interface UseFounderOSIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: FounderOSIssueRuntimeSendOptions) => Promise<void>;
...
export function useFounderOSIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseFounderOSIssueRuntimeOptions) {
