...
export const DISMISSED_KEY = "founderos:inbox:dismissed";
export const READ_ITEMS_KEY = "founderos:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "founderos:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "founderos:inbox:issue-columns";
export const INBOX_NESTING_KEY = "founderos:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "founderos:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "founderos:inbox:filters";
