...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "heartbeat.invoked": "started a shift for",
  "heartbeat.cancelled": "cancelled a shift for",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "agent.created": "hired a teammate",
  "agent.updated": "updated a teammate",
  "agent.paused": "put a teammate on leave",
  "agent.resumed": "brought a teammate back",
  "agent.terminated": "let a teammate go",
  "heartbeat.invoked": "started a shift",
  "heartbeat.cancelled": "cancelled a shift",
  "approval.created": "requested approval",
  "approval.approved": "approved",
  "approval.rejected": "rejected",
};
