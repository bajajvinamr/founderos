...
Manage companies within your FounderOS instance.
...
Company logo uploads use the normal FounderOS attachment size limit.
...
| `logoUrl` | string | Optional FounderOS asset content path for the stored logo image |
