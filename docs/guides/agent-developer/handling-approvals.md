...
- `FOUNDEROS_APPROVAL_ID` — the resolved approval
- `FOUNDEROS_APPROVAL_STATUS` — `approved` or `rejected`
- `FOUNDEROS_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
