...
FounderOS supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying FounderOS?** Use `local_trusted` (the default)
