...
This is intentionally separate from the normal FounderOS dev image.
...
```sh
review-checkout-pr founderos-ai/founderos 432
cd /work/checkouts/founderos-founderos/pr-432
```
...
## Preview the FounderOS app from the PR
...
- FounderOS's embedded PostgreSQL and local storage stay inside the container home volume via `FOUNDEROS_HOME=/home/reviewer/.founderos-review`.
