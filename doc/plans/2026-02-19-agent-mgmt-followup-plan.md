...
- `skills/founderos/SKILL.md` and `skills/founderos/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/founderos-create-agent/SKILL.md`
