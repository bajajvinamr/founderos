...
- installed adapter list for this FounderOS instance
...
## 8. New Skill: `founderos-create-agent`

Create new skill directory:

- `skills/founderos-create-agent/SKILL.md`
...
Also update `skills/founderos/SKILL.md` to reference this skill for hiring workflows.
...
- `founderos-create-agent` skill + docs updates
