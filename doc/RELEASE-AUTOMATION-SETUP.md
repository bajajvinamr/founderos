...
This document covers the GitHub and npm setup required for the current FounderOS release model:
...
Do this for every public package that FounderOS publishes.
...
3. add a trusted publisher for the GitHub repository `founderos-ai/founderos`
...
2. revoke any personal automation token that used to publish FounderOS
